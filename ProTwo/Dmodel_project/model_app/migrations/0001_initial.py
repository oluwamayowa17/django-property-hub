    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='model_app.category', verbose_name='Categories of Post')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model_app.post')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
